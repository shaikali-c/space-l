  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-[60vw_40vw] min-h-screen">
      <section className="relative md:mb-0 mb-10">
        <header className="md:px-20 md:py-15 p-7 text-lg flex justify-between items-center">
          <h2>SPACE.</h2>
          <div className="bg-neutral-900 p-3 rounded-full">
            <Search size={20} />
          </div>
        </header>
        <div className="md:absolute bottom-5 left-5 md:p-20 p-7 pb-0 flex flex-col gap-4.5">
          <h2 className={`text-4xl md:max-w-150`}>
